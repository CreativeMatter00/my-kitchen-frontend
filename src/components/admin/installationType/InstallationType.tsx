...
import InstallationTypeAdd from "./InstallationTypeAdd";
import InstallationTypeEdit from "./InstallationTypeEdit";
...
const InstallationType: React.FC = () => {
  const dispatch = useDispatch();
  const { data = [], isLoading, error } = useFetchData(['installationsType'], `/v1/installation-types`)
  ...
  return (
    <div>
      <DataTable data={data} columns={columns} searchFieldName={'name'} tableName="Installation Type" setAddModalOpen={setAddModalOpen} />
      <Dialog open={addModalOpen} onOpenChange={setAddModalOpen}>
        <DialogContent className="bg-white w-[50vw]">
          <DialogHeader>

            <DialogDescription>
              <InstallationTypeAdd modalClose={setAddModalOpen} />
            </DialogDescription>
          </DialogHeader>
        </DialogContent>
      </Dialog>
      <Dialog open={viewModalOpen} onOpenChange={setViewModalOpen}>
        ...
        <DialogContent className="bg-white w-[50vw]">
          <DialogHeader>
            ...
            <DialogDescription>
              <InstallationTypeEdit modalClose={setEditModalOpen} />
            </DialogDescription>
          </DialogHeader>
        </DialogContent>
      </Dialog>
