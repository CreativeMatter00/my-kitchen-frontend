...
const Category: React.FC = () => {
    ...
    const { data = [], isLoading, error } = useFetchData(['categories'], `/v1/category`)
    ...
    return (
        <div>
            <DataTable data={data} columns={columns} searchFieldName={'name'} tableName="Category" setAddModalOpen={setAddModalOpen} />
