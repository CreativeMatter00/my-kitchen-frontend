...
const Color: React.FC = () => {
  ...
  const { data = [], isLoading, error } = useFetchData(['colors'], `/v1/color`)
  ...
  return (
    <div>
      <DataTable data={data} columns={columns} searchFieldName={'name'} tableName="Color" setAddModalOpen={setAddModalOpen} />
