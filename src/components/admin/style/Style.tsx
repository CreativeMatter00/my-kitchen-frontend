...
import AddMaterial from "./AddStyle";
import EditMaterial from "./EditStyle";
...
const Style: React.FC = () => {
  ...
  const { data = [], isLoading, error } = useFetchData(['styles'], `/v1/style`)
  ...
  return (
    <div>
      <DataTable data={data} columns={columns} searchFieldName={'name'} tableName="Styles" setAddModalOpen={setAddModalOpen} />
