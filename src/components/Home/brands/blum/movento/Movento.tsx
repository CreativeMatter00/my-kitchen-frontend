...
const Movento = () => {
  //const [selectedText, setSelectedText] = useState("Legrabox");
  return (
    <div className="container mx-auto mt-10 pb-8">
<BreadcrumbOfHome/>
      <div className="flex flex-col gap-4 md:gap-6 lg:gap-8">
      <div>
        <p className="text-2xl md:text-5xl lg:text-7xl text-center font-normal text-text">Movento</p>
      </div>
      <div>
